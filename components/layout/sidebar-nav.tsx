...
const MENU_UTAMA = [
  ...
  { label: "Lapor Warga", href: "/lapor-warga", icon: Flag },
...
export function SidebarNav({ profile }: SidebarNavProps) {
  ...
  return (
    <aside className="w-[220px] min-h-screen flex flex-col flex-shrink-0"
      style={{ background: "#1E3A8A" }}>

      <div className="px-5 py-5 border-b border-white/10">
        <div className="flex items-center gap-2.5">
          <svg width="28" height="28" viewBox="0 0 100 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15 100 C15 100 5 85 5 60 C5 35 20 15 45 8 L65 5 C80 3 95 15 95 35 C95 55 80 65 65 70 L40 78 C25 83 20 92 25 105 Z" fill="#60A5FA"/>
            <path d="M25 108 C25 108 18 95 20 75 C22 55 35 42 55 38 L72 35 C83 33 90 42 88 55 C86 68 76 75 65 78 L45 84 C32 89 28 98 32 110 Z" fill="#3B82F6"/>
            <path d="M35 112 C35 112 30 100 33 85 C36 70 47 60 63 57 L76 55 C84 54 89 61 87 70 C85 79 77 85 68 87 L52 92 C42 96 38 104 40 114 Z" fill="#93C5FD"/>
          </svg>
