...
export const metadata: Metadata = {
  ...
  description: "Pantau dan sampaikan laporan aspirasi warga desa.",
};
...
export default async function LaporanPublikPage({
  ...
  const tab     = params.tab === "buat" ? "buat" : "daftar";
  const page    = params.page ? parseInt(params.page) : 1;

  const result = desaId && tab === "daftar"
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          Sampaikan aspirasi atau pantau laporan yang masuk ke perangkat desa.
        </p>
      </div>

      <div className="flex gap-1 p-1 bg-slate-100 rounded-xl w-fit">
        <Link
          href={buildUrl({ tab: "daftar", page: "1" })}
        ...
        <>
          {!desaId ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
              <div className="mb-6">
                <h2 className="text-base font-semibold text-slate-800">Kirim Laporan / Aspirasi</h2>
